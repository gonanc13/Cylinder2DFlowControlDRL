...
def resume_env(plot=False, # To plot results (Field, controls, lift, drag, rec area) during training
    ...
    simulation_duration = 2.0 # Duration of the simulation in seconds. In non-dimensional time this equates to 20.0 (***)
    ...
    if(remesh):
        n_iter = int(20.0 / dt)  # 20 seconds / dt --> Number of iterations
